          ...
          <Box display="flex" flexDirection="column" alignItems="center" p={5}>
            ...
            <Box width="100%">
              ...
              <Box display="flex" justifyContent="space-between">
                <Box component="img" src={sprites.front_female} width="35%" height="35%" />
                <Box component="img" src={sprites.front_shiny} width="35%" height="35%" />
                <Box component="img" src={sprites.front_shiny_female} width="35%" height="35%" />
              </Box>
